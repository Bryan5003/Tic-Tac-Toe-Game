...
public class TicTacToe
{
   ...
   private static void playerTurn(char[][] board, Scanner scan)
   {
      ...
      while(true)
      {
         System.out.println("Pick a spot to play in, (1-9)");
   ...
   private static void computerTurn(char[][] board)
   {
      ...
      while(true)
      {
         ...
         if(isValidMove(board, Integer.toString(cpuTurn)))
         {
            break;
         } 
      }
      System.out.println("Computer chose " + cpuTurn);
      placeMove(board, Integer.toString(cpuTurn), 'O');
   }
